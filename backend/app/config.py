...
class Settings:
    ...
    # TTS-Provider fürs Wort-Vorsprechen (Mikro-Lernschleife). 'browser' =
    # Client spricht selbst (Web Speech API); später 'local'/'azure'/prerender.
    tts_provider: str = os.getenv("FJ_TTS", "browser")
    # Story-Inhalte.
    ...
    # Sanftes Gating: Mindest-Clip-Score zum Weiterkommen (mild).
    min_advance: float = float(os.getenv("FJ_MIN_ADVANCE", "0.55"))
